...
from service_fetchers.services import get_stock_price, get_news, get_weather, get_travel_time, get_hotels, get_flights
...
class UseCases(Enum):
    ...
    FLIGHT_INFORMATION = (8, "Flight Information", ["Start_Airport", "Flight_Destination", "Departure Date", "Return Date"], placeholder)
