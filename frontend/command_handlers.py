...
class CommandHandlers:
    ...
    async def start_initialization(self, update, context):
    ...
    async def initialize_course(self, update, context):
    ...
    async def initialize_cafeteria(self, update, context):
    ...
    async def initialize_city(self, update, context):
    ...
    async def initialize_transport(self, update, context):
    ...
    async def initialize_stocks(self, update, context):
    ...
    async def initialize_news(self, update, context):
        """
    ...
    async def end_initialization(self, update, context):
...
##############################################
    ...
    async def ask_user_for_preference_change(self, update, context, state, message):
        """Fragt den Benutzer nach einem neuen Eintrag für die Präferenz."""
        query = update.callback_query
        await query.message.reply_text(message, parse_mode="Markdown")
        return state

    async def get_summary(self, update, context):
    ...
    async def start_change_preferences(self, update, context):
    ...
    async def change_course(self, update, context):
    ...
    async def change_cafeteria(self, update, context):
    ...
    async def remove_stocks(self, update, context):
    ...
    async def add_stocks(self, update, context):
        stocks = [s.strip() for s in update.message.text.split(",")]
        response = api_client.put_preference(update.effective_user.id, "add_stocks", stocks)
        await update.message.reply_text(response)
        return ConversationHandler.END

    async def remove_news(self, update, context):
    ...
    async def add_news(self, update, context):
        chosen_news = [n.strip() for n in update.message.text.split(",")]
        response = api_client.put_preference(update.effective_user.id, "add_news", chosen_news)
        await update.message.reply_text(response)
        return ConversationHandler.END

    async def process_preference_button_click(self, update, context):
